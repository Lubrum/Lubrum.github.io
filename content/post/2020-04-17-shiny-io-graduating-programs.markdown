...
description: É apresentada uma aplicação de consulta à informações específicas dos Programas de Pós-Graduação em Computação do Brasil desenvolvida com o R e o shiny e publicado com o shinyapps.io. É abordado todo o passo a passo deste processo.
...
<img class="img_content" src="/img/post8/figure1.png" alt="Print da tela com a aplicação em execução na aba mapas.">
...
<img class="img_content" src="/img/post8/figure2.png" alt="Print da tela com a aplicação em execução na aba gráficos.">
...
<img class="img_content" src="/img/post8/figure3.png" alt="Print da tela com a aplicação em execução no shinyapps.io.">
