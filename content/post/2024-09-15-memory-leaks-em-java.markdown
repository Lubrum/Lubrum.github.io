...
description: Um problema frequente em aplicações Java, Memory Leaks são mais difíceis de identificar as causas. Neste artigo, abordo alguns exemplos de situações que já passei.
