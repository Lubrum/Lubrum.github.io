...
description: "Foram explorados dados publicos do IBGE sobre Pecuária Leiteira, específicamente informações dos Censos Agropecuários e da Pesquisa Pecuária Municipal."
...
<img class="img_content" src="/img/post2/gif1.gif" alt="Histórico de 1974 até 2017 da produção leiteira nas UF do Brasil, exibidos no formato de barras por ano">
...
<img class="img_content" src="/img/post2/figure4.png" alt="Mapa com a variação percentual do número de estabelecimentos rurais que produziam leite entre 2006 e 2017 nos municípios do RS">
...
<img class="img_content" src="/img/post2/figure5.png" alt="Mapa com a variação percentual da produção de leite entre 2006 e 2017 nos municípios do RS">
...
<img class="img_content" src="/img/post2/gif2.gif" alt="Mapa animado com a variação absoluta da produção de leite na escala de milhões de litros entre 1974 e 2017 nos municípios do RS">
