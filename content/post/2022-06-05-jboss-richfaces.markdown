...
description: É abordado o funcionamento do Google Maps com o Richfaces versão 3.x (I know, it is old stuff).
...
<img class="img_content" src="/img/post12/figure1.png" alt="Imagem do Google Maps no modo satélite/híbrido com o problema mencionado.">

###### Fonte da imagem: https://i.stack.imgur.com/4a0x3.png

<img class="img_content" src="/img/post12/figure2.png" alt="Imagem do Google Maps no modo satélite/híbrido funcionando normalmente.">
