...
description: É apresentado o passo-a-passo necessário para hospedar um App desenvolvido com R e Shiny de forma gratuita com o shinyapps.io.
date: 2020-03-03 23:55:00 -0300
categories: análise de dados
tags: [R, Shiny, ShinyApps, DataScience, Deploy, Tutorial, RStudio, Cloud]
draft: false
---
...
<img class="img_content" src="/img/post7/figure1.png" alt="Print da página inicial do shinyapps.io.">
...
<img class="img_content" src="/img/post7/figure2.png" alt="Print do RStudio com a instalação do pacote rsconnect.">
...
<img class="img_content" src="/img/post7/figure3.png" alt="Print da tela com a aplicação em execução no shinyapps.io.">
