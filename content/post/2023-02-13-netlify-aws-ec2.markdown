...
description: É apresentado um exemplo de comunicação de um serviço no Netlify (por padrão em HTTPS) e um na Amazon EC2 (free tier).
date: 2023-02-13 00:10:00 -0300
categories: software
tags: [Java, Spring Boot, Netlify, AWS, EC2, Ubuntu, React]
draft: false
---
