...
description: Neste post são demonstrados os passos para instalar e utilizar o Ubuntu como Sistema Operacional principal da sua máquina
...
Com o download realizado, execute-o. 
  ...
  <img class="img_content" src="/img/post10/figure1.png" alt="Software Rufus.">
...
<img class="img_content" src="/img/post10/figure2.jpeg" alt="Tela exibida após pressionar f2.">
...
<img class="img_content" src="/img/post10/figure3.jpeg" alt="Ordem das opções de boot.">
...
<img class="img_content" src="/img/post10/figure4.jpeg" alt="Idioma.">

Idioma de instalação: Português.

<img class="img_content" src="/img/post10/figure5.jpeg" alt="Layout do Teclado.">

Layout do teclado: Português.

<img class="img_content" src="/img/post10/figure6.png" alt="Conexão de rede.">
...
<img class="img_content" src="/img/post10/figure7.jpeg" alt="Atualizações durante a instalação.">
...
<img class="img_content" src="/img/post10/figure8.png" alt="Tipo de instalação.">

Selecionar opção avançada. 
<p style = "color: #ff1111"> Pelo amor de Deus, não marque Apagar disco... </p>

<img class="img_content" src="/img/post10/figure9.png" alt="Detalhes das partições do sistema.">
...
<img class="img_content" src="/img/post10/figure10.png" alt="Detalhes das partições do sistema.">
...
<img class="img_content" src="/img/post10/figure11.jpeg" alt="Fuso Horário.">

Selecione o fuso horário e clique em "Continuar".

<img class="img_content" src="/img/post10/figure12.jpeg" alt="Credenciais para a máquina.">
...
<img class="img_content" src="/img/post10/figure13.png" alt="Credenciais para a máquina.">
