...
description: Quando eu jogava Tibia, tinha a necessidade de estimar, pelo menos, algumas informações sobre as hunts que eu fazia, para saber se eu estava obtendo lucro nas mesmas. Então decidi utilizar o que eu havia aprendido na graduação - a linguagem C.
...
<img class="img_content" src="/img/post5/figure1.png" alt="Print do jogo online Tibia.">
...
<img class="img_content" src="/img/post5/figure2.png" alt="Print do server log de uma hunt do tibia.">
...
<img class="img_content" src="/img/post5/figure3.png" alt="Print do Tibia Stats na ferramenta count loot.">
...
<img class="img_content" src="/img/post5/figure4.png" alt="Print do Tibia Stats na ferramenta count loot.">
