...
<figure class='zoom' style="background: url({{ site.baseurl }}/assets/img/post3/figure6.png)" >
...
<figure class='zoom' style="background: url({{ site.baseurl }}/assets/img/post3/figure9.png)" >
