...
Esse site é operado pelo Data Science World. Em todo o site, os termos “nós”, “nos” e “nosso” se referem ao Data Science World. O Data Science World proporciona esse site, incluindo todas as informações, ferramentas e serviços disponíveis deste site para você, o usuário, com a condição da sua aceitação de todos os termos, condições, políticas e avisos declarados aqui.
...
SEÇÃO 1 - TERMOS DO DATA SCIENCE WORLD
...
SEÇÃO 18 - ALTERAÇÕES DOS TERMOS DE SERVIÇO
